...
import heroImage from "@/assets/partner-hero.jpg";
...
export default function LoginPage({ onLogin }: { onLogin: () => void }) {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          <div className="max-w-lg">
            ...
            <p className="text-xl mb-8 text-white/90 leading-relaxed">
              Manage your stalls, track performance, and grow your business with our comprehensive partner platform.
            </p>
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-secondary rounded-full shadow-glow" />
                <span>Easy Stall Management</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-3 h-3 bg-secondary rounded-full shadow-glow" />
      ...
      <div className="flex-1 lg:flex-none lg:w-1/2 flex items-center justify-center p-8 bg-gradient-subtle">
          ...
          <Card className="shadow-elegant border-0">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                <Button variant="outline" className="h-12 hover:shadow-elegant transition-all duration-300">
